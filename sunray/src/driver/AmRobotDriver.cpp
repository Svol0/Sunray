...
void AmMotorDriver::begin(){
    ...
    // example: mowDriverChip.minPwmSpeed = 40; 
	    ...
	    mowDriverChip.adcVoltToAmpOfs = -1.65;   // brushless-adapter: 0A=1.65V, resolution 132mV/A 
		mowDriverChip.adcVoltToAmpScale = 10.35; 
		mowDriverChip.adcVoltToAmpPow = 0.98;
