// Ardumower Sunray actual master V1.0.276 with added GPS-Reboot by undocking; map setSpeed to app joystickspeed; speed parameters; new linearRamp; adaptiv speed
